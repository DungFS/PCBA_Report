...
nếu DB có nhiều repair, mỗi repair là 1 lần gọi Voyage API), giống cách
import_repair.py cũng chạy qua terminal (./run_import.sh):
...
Yêu cầu: đã cấu hình VOYAGE_API_KEY trong .env (xem app/services/embedding_service.py).
